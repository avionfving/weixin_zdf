...
@Controller
@RequestMapping("/zdf/library/debit")
...
public class DebitController {
	...
	public String debit(@RequestParam("id") String id, WebRequest request) {
		...
		// 添加完成后，重定向到借阅列表的显示页面
		return "redirect:/zdf/library/debit/list";
	}
	...
	// 大括號里面是一个{路径参数}，参数的名称随意
	// 所谓的路径参数：把路径的一部分作为参数使用。在REST规范中，每个资源都有唯一的一个URL。、
	// /book 表示所有的书
	// /book/1 表示id为1的参数
	...
	public String remove(@PathVariable("id") String id, 
			// 从Session里面名为debitList的对象，并且自动强制类型转换
